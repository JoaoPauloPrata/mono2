...
class LatexTableGenerator:
    """
    Gera tabelas LaTeX a partir dos arquivos produzidos pelo FinalResultSplitterLite.
    ...
    def __init__(
        ...
        self.input_dir = os.path.join(base_dir, input_dir.lstrip("./").rstrip("/\\"))
        self.output_dir = os.path.join(base_dir, output_dir.lstrip("./").rstrip("/\\"))
