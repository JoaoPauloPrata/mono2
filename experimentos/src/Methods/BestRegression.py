...
class BestRegression:
    ...
    def loandAndOptimize(self, window_count):
        recs_from_SVD = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_constituent_methods_SVD.tsv", delimiter='\t')
        recs_from_BIAS = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_constituent_methods_BIAS.tsv", delimiter='\t')
        recs_from_userKNN = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_constituent_methods_userKNN.tsv", delimiter='\t')
        recs_from_itemKNN = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_constituent_methods_itemKNN.tsv", delimiter='\t')
        recs_from_biasedMF = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_constituent_methods_BIASEDMF.tsv", delimiter='\t')
        ...
        scikit_test_data = pd.read_csv('./data/windows/test_to_get_regression_train_data_' + str(window_count) + ".csv", sep=',')

        recs_from_SVD_to_train_scikit = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_scikit_train_SVD.tsv", delimiter='\t')
        recs_from_BIAS_to_train_scikit = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_scikit_train_BIAS.tsv", delimiter='\t')
        recs_from_userKNN_to_train_scikit = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_scikit_train_userKNN.tsv", delimiter='\t')
        recs_from_itemKNN_to_train_scikit = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_scikit_train_itemKNN.tsv", delimiter='\t')
        recs_from_biasedMF_to_train_scikit = pd.read_csv("./data/filtered_predictions/window_" +str(window_count)+ "_scikit_train_BIASEDMF.tsv", delimiter='\t')
